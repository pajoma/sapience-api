...
public class Suite_02 extends TestLifeCycle {
	...
	private String annotatedFile = "WSDL11/wsdl11-sawsdl-testcases/03-operation-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl11/Suite_02");
	...
	public void testInject() throws IOException {
		...
		Pattern pattern = Pattern.compile(".*sawsdl:modelReference=\"http://www.w3.org/2002/ws/sawsdl/spec/ontology/purchaseorder#RequestPurchaseOrder\"/>", Pattern.DOTALL);
