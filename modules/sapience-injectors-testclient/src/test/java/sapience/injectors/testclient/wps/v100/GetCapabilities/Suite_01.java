...
public class Suite_01 extends TestLifeCycle {
	...
	private String annotatedFile = "wps100/wps100-capabilities-testcases/01-serviceIdentification-annotation.xml";
	...
	public void testExtract() throws IOException {
			...
			sid = asHEX("http://example.com/wps/getCapabilities/Suite_01");
