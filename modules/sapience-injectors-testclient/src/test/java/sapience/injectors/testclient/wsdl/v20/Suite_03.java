...
public class Suite_03 extends TestLifeCycle {
	...
	private String notAnnotatedFile = "WSDL20/wsdl20-sawsdl-testcases/03-operation.wsdl";
	private String annotatedFile = "WSDL20/wsdl20-sawsdl-testcases/03-operation-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl/Suite_03");
	...
	public void testInject() throws IOException {
		...
		pattern = Pattern.compile("sawsdl:modelReference=\"http://www.w3.org/2002/ws/sawsdl/spec/ontology/purchaseorder#RequestPurchaseOrder\"", Pattern.DOTALL);
