...
public class Suite_06 extends TestLifeCycle {
	...
	private String annotatedFile = "WSDL11/wsdl11-sawsdl-testcases/08-attribute-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl11/Suite_06");
	...
	public void testInject() throws IOException {
		...
		pattern = Pattern.compile(".*sawsdl:modelReference=\"http://www.w3.org/2002/ws/sawsdl/spec/ontology/purchaseorder#Quantity", Pattern.DOTALL);
