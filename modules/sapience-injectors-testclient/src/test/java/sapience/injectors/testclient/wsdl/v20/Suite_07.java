...
public class Suite_07 extends TestLifeCycle {

	@Autowired ConfigurationFactory config;

	private String sid;

	private String notAnnotatedFile = "WSDL20/wsdl20-sawsdl-testcases/08-attribute.wsdl";
	private String annotatedFile = "WSDL20/wsdl20-sawsdl-testcases/08-attribute-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl/Suite_07");
	...
	public void testInject() throws IOException {
		...
		pattern = Pattern.compile("<xs:attribute.*sawsdl:modelReference=\"http://www.w3.org/2002/ws/sawsdl/spec/ontology/purchaseorder#Quantity\"/>", Pattern.DOTALL);
