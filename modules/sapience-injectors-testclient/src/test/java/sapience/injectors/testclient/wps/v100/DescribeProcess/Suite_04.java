...
public class Suite_04 extends TestLifeCycle {
	...
	private String annotatedFile = "wps100/wps100-describeProcess-testcases/00-all-annotation.xml";
	...
	public void testExtract() throws IOException {
			...
			sid = asHEX("http://example.com/wps/DescribeProcess/Suite_04");
	...
	public void testInject() throws IOException {
		...
		try {
			...
			pattern = Pattern.compile(".*xlink:href=\"http://www.concepts.com/Process/url\".*", Pattern.DOTALL);
			...
			pattern = Pattern.compile(".*xlink:href=\"http://www.concepts.com/output/url\".*xlink:arcrole=\"http://domainReference\".*", Pattern.DOTALL);
			Assert.assertTrue(pattern.matcher(result).matches());
