...
public class Suite_01 extends TestLifeCycle {
	...
	private String annotatedFile = "WSDL11/wsdl11-sawsdl-testcases/01-portType-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl11/Suite_01");
	...
	public void testInject() throws IOException {
		...
		pattern = Pattern.compile(".*sawsdl:modelReference=\"http://example.org/categorization/products/electronics\".*", Pattern.DOTALL);
