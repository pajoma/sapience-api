...
public class Suite_04 extends TestLifeCycle {
	...
	private String notAnnotatedFile = "WSDL20/wsdl20-sawsdl-testcases/04-fault.wsdl";
	private String annotatedFile = "WSDL20/wsdl20-sawsdl-testcases/04-fault-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl/Suite_04");
	...
	public void testInject() throws IOException {
		...
		pattern = Pattern.compile("sawsdl:modelReference=\"http://www.w3.org/2002/ws/sawsdl/spec/ontology/purchaseorder#ItemUnavailable\"", Pattern.DOTALL);
