...
public class Suite_05 extends TestLifeCycle {

	@Autowired ConfigurationFactory config;

	private String sid;

	private String notAnnotatedFile = "WSDL20/wsdl20-sawsdl-testcases/05-simpletype.wsdl";
	private String annotatedFile = "WSDL20/wsdl20-sawsdl-testcases/05-simpletype-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl/Suite_05");
	...
	public void testInject() throws IOException {
		...
		pattern = Pattern.compile("<xs:simpleType.*sawsdl:modelReference=\"http://www.w3.org/2002/ws/sawsdl/spec/ontology/purchaseorder#OrderConfirmation\">", Pattern.DOTALL);
