...
public class Suite_02 extends TestLifeCycle {
	...
	private String notAnnotatedFile = "WSDL20/wsdl20-sawsdl-testcases/02-extended-interface.wsdl";
	private String annotatedFile = "WSDL20/wsdl20-sawsdl-testcases/02-extended-interface-annotation.wsdl";
	...
	public void testExtract() throws IOException {
		...
		sid = asHEX("http://example.com/wsdl/Suite_02");
	...
	public void testInject() throws IOException {
		...
		pattern = Pattern.compile("wsdl:interface.*sawsdl:modelReference=\"http://example.org/categorization/services/delivery\"", Pattern.DOTALL);
		Assert.assertTrue(pattern.matcher(result).find());		
	}
